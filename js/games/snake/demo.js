...
function reloadGame() {
    ...
    startPaush.setAttribute('src', 'https://cdn.jsdelivr.net/gh/666WXY666/cdn@master/js/games/snake/images/start.png');
    this.snakeBody = [[3, 1, 'head'], [2, 1, 'body'], [1, 1, 'body']];
...
function startAndPaush() {
    if (startPaushBool) {
        ...
        startPaush.setAttribute('src', 'https://cdn.jsdelivr.net/gh/666WXY666/cdn@master/js/games/snake/images/pause.png');
